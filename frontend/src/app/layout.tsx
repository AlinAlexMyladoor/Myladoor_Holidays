    ...
    <html lang="en" className="scroll-smooth">
      ...
      <body className="bg-[#0d1117] font-sans antialiased text-gray-100 flex flex-col min-h-screen overflow-x-hidden">
        ...
        <a
          ...
          className="wa-btn fixed bottom-6 right-6 z-50 w-14 h-14 bg-green-500 hover:bg-green-400 text-white flex items-center justify-center shadow-2xl transition-all duration-300 hover:scale-110 rounded-full"
        >
